...
import org.apache.flink.datastream.impl.extension.window.utils.WindowUtil;
...
/** Process operator for one input window. */
public class TwoOutputWindowProcessOperator<K, IN, OUT_MAIN, OUT_SIDE, W extends Window>
    ...
    private TwoOutputWindowStreamProcessFunction<IN, OUT_MAIN, OUT_SIDE> windowProcessFunction;
    ...
    public void open() throws Exception {
        ...
        windowFunctionContext =
                new DefaultOneInputWindowContext<>(
                        null, windowState, windowProcessFunction, this, windowSerializer);
    }
    ...
    public void processElement(StreamRecord<IN> element) throws Exception {
        ...
        if (windowAssigner instanceof MergingWindowAssigner) {
            ...
            for (W window : elementWindows) {
                ...
                WindowUtil.registerCleanupTimer(
